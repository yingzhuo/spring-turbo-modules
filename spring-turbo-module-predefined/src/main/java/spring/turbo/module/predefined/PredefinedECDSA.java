...
public final class PredefinedECDSA {
    ...
    public static Pair<String, String> loadKeys(int i) {
        ...
        final String a = ResourceOptions
                .fromCommaSeparatedLocations(String.format("classpath:ecdsa/ecdsa.public.%d.txt", i)).toString(UTF_8);
        final String b = ResourceOptions
                .fromCommaSeparatedLocations(String.format("classpath:ecdsa/ecdsa.private.%d.txt", i)).toString(UTF_8);
    ...
    public static ECDSA createCrypto(int i) {
        ...
        return ECDSA.builder()
                .keyPair(ECDSAKeys.fromString(ks.getA(), ks.getB()))
                .build();
    }
